...
&nbsp;&nbsp;&nbsp;&nbsp;&bull; [Impact](#impact)  
&bull; [Usage:](#usage)  
&nbsp;&nbsp;&nbsp;&nbsp;&bull; [netmon.sh](#netmonsh)  
&nbsp;&nbsp;&nbsp;&nbsp;&bull; [netmon_start.sh](#netmon_startsh)  
&nbsp;&nbsp;&nbsp;&nbsp;&bull; [netmon_check.sh](#netmon_checksh)  
&nbsp;&nbsp;&nbsp;&nbsp;&bull; [netmon_sample.sh](#netmon_samplesh)  
&nbsp;&nbsp;&nbsp;&nbsp;&bull; [netmon_stop.sh](#netmon_stopsh)  
&bull; [Design](#design)  
&nbsp;&nbsp;&nbsp;&nbsp;&bull; [Interpretation of Data](#interpretation-of-data)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&bull; [Nodesc Drops](#nodesc-drops)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&bull; [Onload Oflow Drops](#onload-oflow-drops)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&bull; [Onload Mem Drops](#onload-mem-drops)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&bull; [UDP Receive Errors](#udp-receive-errors)  
&bull; [Configuration](#configuration)  
&bull; [Log File: Rolling](#log-file-rolling)  
&bull; [Log File: Fixed](#log-file-fixed)  
&bull; [Graceful Exit](#graceful-exit)  
